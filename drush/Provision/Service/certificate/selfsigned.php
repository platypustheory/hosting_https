...
/**
 * A class containing the 'selfsigned' implementation of the 'certificate' service.
 *
 * This class is conditionally loaded when the "--certificate_service_type=selfsigned"
...
class Provision_Service_certificate_selfsigned extends Provision_Service_certificate {
  ...
  */
  ...
  function init_server() {
     ...
     */
    $this->configs['server'][] = 'Provision_Config_Certificate';
     ...
     *    $this->server->setProperty('certificate_field', 'default');
     *
     ...
     *
     *   $this->server->certificate_config_path = $this->server->config_path . '/certificate.d'
     *
  ...
  function verify() {
    ...
    if ($this->context->type == 'server') {
      ...
      provision_file()->create_dir($this->server->certificate_config_path, dt("Certificate configuration"), 0700);
      // Sync the directory to the remote server if needed.
      $this->sync($this->server->certificate_config_path);
    }
  }
}
